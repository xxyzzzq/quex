...
typedef QUEX_TYPE_TOKEN_WITH_NAMESPACE_ID   (*GetTokenIDFuncP)(void);
typedef void                 (*ResetFuncP)(void);

// main.cpp
QUEX_TYPE_TOKEN_WITH_NAMESPACE_ID func_get_token_id();
QUEX_TYPE_TOKEN_WITH_NAMESPACE_ID func_empty();
void               func_reset();
