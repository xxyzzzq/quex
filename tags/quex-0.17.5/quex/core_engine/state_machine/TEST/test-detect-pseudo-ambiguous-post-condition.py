...
import quex.core_engine.state_machine.detect_pseudo_ambigous_post_condition as apc_detector 
...
def test(RE_Core, RE_PostCondition):
    ...
    print "ambigous post condition =", apc_detector.do(core_sm, post_condition_sm)
