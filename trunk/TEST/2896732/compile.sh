#!/bin/sh
#
quex -i uXa.qx -o Lexer --token-prefix QUEX_UUID_ --token-id-uninitialized 1114112 --token-id-termination 1114113 --token-id-offset 1114114 --token-policy queue --icu -b 2 --nsacc --ttnttc
