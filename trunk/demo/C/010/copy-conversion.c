...
{        
    ...
    *                                                 * lexeme for possible backup.  */
    ...
    QUEX_NAME(from_memory)(&qlex, (QUEX_TYPE_CHARACTER*)0x0, 0, (QUEX_TYPE_CHARACTER*)0x0, "UTF-8", false);
    ...
    while( 1 + 1 == 2 ) {
        ...
        /*     deal with it.) */
        QUEX_NAME(buffer_fill_region_append_conversion)(&qlex, chunk.begin, chunk.end);
