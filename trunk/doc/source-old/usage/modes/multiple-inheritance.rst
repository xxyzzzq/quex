...
The according mode inheritance hierarchy is show in figure :ref:`Inheritance
...
#. Modes that are mentioned before in the inheritance relationship have a higher
   precedence than those mentioned after.  In the above example ``B`` has a higher precedence then ``C``,
...
What sounds complicated is in practice very intuitive. Base mode patterns have
