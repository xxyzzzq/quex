...
inline void
CLASS::InputHandle::memento::map_from_lexical_analyzer(CLASS* TheLexer)
{
...
inline void
CLASS::InputHandle::memento::map_to_lexical_analyzer(CLASS* the_lexer)
{
...
CLASS::IncludeStack::push(InputHandle*      new_input_handle_p, 
                          ...
                          const char*    IConvInputCodingName /* = 0x0 */)
{
    ...
    if( MODE_ID == -1 ) 
        __push(new_input_handle_p, __current_mode_analyser_function_p, IConvInputCodingName); 
    else
        __push(new_input_handle_p, mode_db[MODE_ID]->analyser_function, IConvInputCodingName);
}

template <class InputHandle> inline void    
CLASS::IncludeStack::__push(InputHandle*         new_input_handle_p, 
                            ...
                            const char*          IConvInputCodingName)
{
    ...
    _stack.push_back(CLASS::memento());
