...
namespace quex {
    ...
    QUEX_INLINE_KEYWORD CLASS::FixedSizeCharacterStream_IConv(QUEX_CHARACTER_TYPE* input_handle, 
    ...
    { 
        ...
        begin_info.position        = InputPolicy<QUEX_CHARACTER_TYPE*>::tell(input_handle);
    ...
    QUEX_INLINE_KEYWORD CLASS::~FixedSizeCharacterStream_IConv() 
    ...
    QUEX_INLINE_KEYWORD void CLASS::__fill_raw_buffer() 
    {
    ...
    QUEX_INLINE_KEYWORD bool CLASS::__convert(buffer_info* user_buffer) 
    ...
    QUEX_INLINE_KEYWORD size_t CLASS::tell_character_index()
    { return end_character_index; }

    QUEX_INLINE_KEYWORD void CLASS::seek_character_index(const size_t CharacterIndex) 
    { 
    ...
    QUEX_INLINE_KEYWORD void CLASS::__seek_character_index_in_stream(stream_position   HintStreamPos, 
    ...
    QUEX_INLINE_KEYWORD void  CLASS::register_begin_of_file() 
    { 
        start_position = InputPolicy<QUEX_CHARACTER_TYPE*>::tell(ih); 
    }

    QUEX_INLINE_KEYWORD void  CLASS::seek_begin_of_file()
    {
        InputPolicy<QUEX_CHARACTER_TYPE*>::seek(ih, start_position);
    }

    QUEX_INLINE_KEYWORD bool CLASS::has_input_format_dynamic_character_width() 
    {
        return true; // TODO: distinguish between different coding formats
        //           //       'true' is safe, but possibly a little slower.
    }

    QUEX_INLINE_KEYWORD CLASS::buffer_info::buffer_info(uint8_t* Begin, size_t SizeInBytes)
    {
        begin        = Begin;
        size         = SizeInBytes;
        position     = begin;
