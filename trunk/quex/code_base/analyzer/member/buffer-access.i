...
QUEX_NAMESPACE_MAIN_OPEN
     ...
     *          is equal to BufferEnd.                                        */
    {
        ...
        __quex_assert(me->engine.buffer._content_character_index_begin == 0); 
        __quex_assert(me->engine.buffer._memory._end_of_file_p != 0x0); 
