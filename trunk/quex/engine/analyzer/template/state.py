...
class MegaState_Entry(Entry):
    def __init__(self, StateIndex, EntryA, EntryB, StateIndexToStateKeyDB):
        Entry.__init__(self, StateIndex, [])
        self.__update_entry(EntryA, StateIndexToStateKeyDB)
        self.__update_entry(EntryB, StateIndexToStateKeyDB)
        Entry.door_tree_configure(self)

    def __update_entry(self, TheEntry, StateIndexToStateKeyDB):
...
class TemplateState(AnalyzerState):
    ...
    def __init__(self, StateA, StateB, TheAnalyzer):
        ...
        self.__entry    = MegaState_Entry(self.index, StateA.entry, StateB.entry, 
                                          state_index_to_state_key_db)
