...
Option("input_mode_files", "[file name]+",
    """
    The file names following \\v{-i} are the files containing quex source
    code to be used as input.
    """),
Option("analyzer_class", "[name ::]+ name",
    """
    \\v{name} = Name of the lexical analyser class that is to be created
    inside the namespace \\v{quex}. This name also determines the
    ...
    placed in the root name space shall be used a \\v{::} must be proceeding
    ...
    in the namespace \\v{MySubSubSpace} which in turn is located \\v{MySubSpace} which
    it located in \\v{MySpace}. A specification
    """,
...
Option("output_file_naming_scheme", "scheme",
    ...
    \\v{--language} command line option. 
    """,
    Item("C++", 
    ...
    """
    For \\v{C} there is currently no different naming scheme supported.
    """),
...
Option("external_lexeme_null_object", "variable", 
     """
     The 'name' is the name of the \\v{LexemeNull} object. If the option is
...
Option("buffer_limit_code", "number", 
     """Numeric value used to mark buffer borders. This should be a number that
...
Option("buffer_byte_order", "little|big|<system>",
       """
        ...
        """,
        List(
        "\\v{__QUEX_OPTION_SYSTEM_ENDIAN}",
        "\\v{__QUEX_OPTION_LITTLE_ENDIAN`",
