...
class TemplateState(MegaState):
    ...
    def __init__(self, Candidate):
        ...
        transition_map, target_scheme_n = combine_maps(StateA, StateB)
...
class PseudoTemplateState(MegaState): 
    ...
    def __init__(self, Represented_AnalyzerState):
        ...
        transition_map = self._finalize_transition_map(Represented_AnalyzerState)
        ski_db         = StateKeyIndexDB([Represented_AnalyzerState.index])
        MegaState.__init__(self, Represented_AnalyzerState.index, transition_map, ski_db)
        ...
        self._finalize_transition_map(Represented_AnalyzerState)

    def _finalize_transition_map(self, Represented_AnalyzerState):
        class Factory:
