...
class TemplateState(AnalyzerState):
    ...
    def __init__(self, StateA, StateB):
        ...
        self.__entry    = combine_scheme(StateA.index, StateA.entry,    StateB.index, StateB.entry)
        self.__drop_out = combine_scheme(StateA.index, StateA.drop_out, StateB.index, StateB.drop_out)
