    ...
    def __update_entry(self, TheState):
        ...
        if isinstance(TheState, AnalyzerState):
            for from_state_index, transition_action in TheState.entry.action_db.iteritems():
                transition_action.misc.add(entry_action.SetStateKey(self.__state_index_to_state_key_db[TheState.index]))
                self.__entry.action_db[TransitionID(StateA.index, from_state_index)] = transition_action
            ...
            for transition_id, transition_action in TheState.entry.action_db.iteritems():
                ...
                for action in transition_action.misc:
                    if not isinstance(action, entry_action.SetStateKey): break
