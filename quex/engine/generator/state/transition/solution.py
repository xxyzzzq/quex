...
#
#class CostRecord:
#    def __init__(self, TriggerMap, Begin, End):
#
#        self.branch_table = CostRecord.get_branch_table_cost(TriggerMap, Begin, End)
#        self.linear_cmp   = CostRecord.get_linear_cmp_cost(TriggerMap, Begin, End)
#        self.bisection    = CostRecord.get_bisection_cost(TriggerMap, Begin, End)
#
#    @staticmethod
#    def get_branch_table_cost(TriggerMap, Begin, End):
#        pass
#    def get_linear_cmp_cost(TriggerMap, Begin, End):
#        pass
#    def get_bisection_cost(TriggerMap, Begin, End):
#        pass
