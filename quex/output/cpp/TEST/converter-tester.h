#ifndef __QUEX_INCLUDE_GUARD__CONVERTER_HELPER__cp737__
...
#ifndef __QUEX_INCLUDE_GUARD__CONVERTER_HELPER__cp737_I
...
QUEX_INLINE void
__QUEX_CONVERTER_CHAR(cp737, utf8)(const QUEX_TYPE_CHARACTER**  input_pp, 
                                       uint8_t**                    output_pp)
{
    const int NEXT = 0x80;
...
QUEX_INLINE void
__QUEX_CONVERTER_CHAR(cp737, utf16)(const QUEX_TYPE_CHARACTER** input_pp,
                                        uint16_t**                  output_pp)
{
    uint16_t             unicode = 0L;
    QUEX_TYPE_CHARACTER  input = **input_pp;
...
QUEX_INLINE void
__QUEX_CONVERTER_CHAR(cp737, utf32)(const QUEX_TYPE_CHARACTER** input_pp,
                                        uint16_t**                  output_pp)
{
    uint32_t             unicode = 0L;
    QUEX_TYPE_CHARACTER  input = **input_pp;
