...
{
    me->the_lexer       = lexer;
    me->text.begin      = QUEX_NAME(MemoryManager_AccumulatorText_allocate)(QUEX_SETTING_ACCUMULATOR_INITIAL_SIZE);
...
QUEX_NAME(Accumulator_extend)(QUEX_TYPE_ACCUMULATOR* me, size_t MinAddSize)
{
    ...
    QUEX_TYPE_CHARACTER*  chunk = QUEX_NAME(MemoryManager_AccumulatorText_allocate)(NewSize);
