...
#       ifndef __QUEX_SETTING_PLAIN_C
        QUEX_FUNC(include_push)<InputHandleT>((QUEX_NAME(AnalyzerData)*)me, InputName, mode->id(), CharacterCodecName);
#       else
        QUEX_FUNC(include_push)((QUEX_NAME(AnalyzerData)*)me, InputName, mode->id(), CharacterCodecName);
#       endif
    }
