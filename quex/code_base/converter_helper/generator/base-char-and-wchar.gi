...
#if   __QUEX_DRAIN_CODEC == 8
    __quex_assert(sizeof(__QUEX_TYPE_DRAIN) == 1);
    std::basic_string<uint8_t> tmp = __QUEX_CONVERTER_STRING(__QUEX_G_SOURCE_NAME, utf8)(Source);

#elif __QUEX_DRAIN_CODEC == 16
    __quex_assert(sizeof(__QUEX_TYPE_DRAIN) == 2);
    std::basic_string<uint16_t> tmp = __QUEX_CONVERTER_STRING(__QUEX_G_SOURCE_NAME, utf16)(Source);

#elif __QUEX_DRAIN_CODEC == 32
    __quex_assert(sizeof(__QUEX_TYPE_DRAIN) == 4);
    std::basic_string<uint32_t> tmp = __QUEX_CONVERTER_STRING(__QUEX_G_SOURCE_NAME, utf32)(Source);
#endif
