...
namespace quex {
                              ...
                              QUEX_CHARACTER_TYPE** drain,  const QUEX_CHARACTER_TYPE*  DrainEnd)
    {
        ...
        if( me->to_handle == 0x0 ) {
             ...
             *       of QUEX_CHARACTER_TYPE. If you read these lines and know of a better
            ...
            __quex_assert( sizeof(QUEX_CHARACTER_TYPE) == 2 );
    ...
    QuexConverter_ICU_delete_self(QuexConverter* alter_ego)
    {
        ...
        MemoryManager_Converter_ICU_free(me);
    ...
    {
        QuexConverter_ICU*  me = MemoryManager_Converter_ICU_allocate();
